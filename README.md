...
## Installation
Clone the repository first and make sure you have `python3` with `argparse` and `PyCryptodome` installed. If you don't:
```bash
...
> [!NOTE]
> Ciphertext is generated and used in raw format.
